...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         * page? (the test fails and turns red and gives a error code telling you where it failed and why to an extent)
         */
         ...
         * and that the name is not empty and are a string.
         */
